...
namespace nillauncher.Utils
{
    ...
    public class R7z
    {
        public static void R7Zip(string dirpath,string targetfile)
        {
            SevenZipBase.SetLibraryPath(AppContext.BaseDirectory + "7z.dll");
            var zip = new SevenZipCompressor();
            Console.WriteLine(File.Exists(AppContext.BaseDirectory+"7z.dll"));


            zip.CompressionLevel = CompressionLevel.High;
            zip.CompressDirectory(dirpath,targetfile);
        }
    }*/
}